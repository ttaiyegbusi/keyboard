...
//
// Defines every key row on the keyboard.
// Each key object describes how it looks and what it does.
//
// Key types:
//   "char"    → produces a character (has normal + shift variant)
//   "special" → functional key (Backspace, Enter, Shift, etc.)
//   "fn"      → function key row with icon + label
//   "knob"    → the circular dial (decorative)
// ─────────────────────────────────────────────────────────────
...
export interface KeyDef {
  ...
  type: KeyType;
  /** Unique key identifier (maps to e.code from physical keyboard) */
  code?: string;
  /** Character produced when not shifted */
  char?: string;
  /** Character produced when shifted */
  shift?: string;
  /** Label text to display (for special keys) */
  label?: string;
  /** Label alignment: "left" | "right" | "center" */
  labelAlign?: "left" | "right" | "center";
  /** CSS width class, e.g. "k-std", "k-tab" */
  sizeClass: string;
  /** Function key number, e.g. "F1" */
  fnLabel?: string;
  /** SVG path data for the function key icon */
  fnIcon?: string;
  /** Whether this is a homing key (F or J — has tactile bar) */
  homing?: boolean;
  /** Marks this as one of the shift keys */
  isShift?: boolean;
  /** Marks this as caps lock */
  isCaps?: boolean;
}

// ── SVG path snippets for function-row icons ──────────────────
const ICONS = {
  brightDown:
    'M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z',
  brightUp:
    'M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10z',
  missionCtrl:
    'M2 3h8a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM14 3h8a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM2 13h8a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1zM14 13h8a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1z',
...
export const ROW_QWERTY: KeyDef[] = [
  ...
  { type: "char", code: "KeyQ", char: "q", shift: "Q", sizeClass: "k-std" },
  { type: "char", code: "KeyW", char: "w", shift: "W", sizeClass: "k-std" },
  { type: "char", code: "KeyE", char: "e", shift: "E", sizeClass: "k-std" },
  { type: "char", code: "KeyR", char: "r", shift: "R", sizeClass: "k-std" },
  { type: "char", code: "KeyT", char: "t", shift: "T", sizeClass: "k-std" },
  { type: "char", code: "KeyY", char: "y", shift: "Y", sizeClass: "k-std" },
  { type: "char", code: "KeyU", char: "u", shift: "U", sizeClass: "k-std" },
  { type: "char", code: "KeyI", char: "i", shift: "I", sizeClass: "k-std" },
  { type: "char", code: "KeyO", char: "o", shift: "O", sizeClass: "k-std" },
  { type: "char", code: "KeyP", char: "p", shift: "P", sizeClass: "k-std" },
...
export const ROW_HOME: KeyDef[] = [
  ...
  { type: "char", code: "KeyA", char: "a", shift: "A", sizeClass: "k-std" },
  { type: "char", code: "KeyS", char: "s", shift: "S", sizeClass: "k-std" },
  { type: "char", code: "KeyD", char: "d", shift: "D", sizeClass: "k-std" },
  { type: "char", code: "KeyF", char: "f", shift: "F", sizeClass: "k-std", homing: true },
  { type: "char", code: "KeyG", char: "g", shift: "G", sizeClass: "k-std" },
  { type: "char", code: "KeyH", char: "h", shift: "H", sizeClass: "k-std" },
  { type: "char", code: "KeyJ", char: "j", shift: "J", sizeClass: "k-std", homing: true },
  { type: "char", code: "KeyK", char: "k", shift: "K", sizeClass: "k-std" },
  { type: "char", code: "KeyL", char: "l", shift: "L", sizeClass: "k-std" },
...
export const ROW_SHIFT: KeyDef[] = [
  ...
  { type: "char", code: "KeyZ", char: "z", shift: "Z", sizeClass: "k-std" },
  { type: "char", code: "KeyX", char: "x", shift: "X", sizeClass: "k-std" },
  { type: "char", code: "KeyC", char: "c", shift: "C", sizeClass: "k-std" },
  { type: "char", code: "KeyV", char: "v", shift: "V", sizeClass: "k-std" },
  { type: "char", code: "KeyB", char: "b", shift: "B", sizeClass: "k-std" },
  { type: "char", code: "KeyN", char: "n", shift: "N", sizeClass: "k-std" },
  { type: "char", code: "KeyM", char: "m", shift: "M", sizeClass: "k-std" },
...
// Bottom modifier row is defined inline in the component
// because it contains mixed layout (globe icon, arrows cluster, etc.)
